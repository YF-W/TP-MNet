...
class TP_MNet(nn.Module):
    def __init__(self, features=[64, 128, 256, 512], out_channels=1):
        ...
        self.upsampleups.append(DoubleConv(256 + 512 + 512, 256))  # 双卷积(此前粘贴邻分枝上一层)
        self.upsampleups.append(nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2))  # 第3-第2上采样
        self.upsampleups.append(DoubleConv(128 + 256 + 256, 128))  # 双卷积(此前粘贴邻分枝上一层)
        ...
        self.skups.append(DoubleConv(256 + 65 + 512, 256))  # 双卷积
        self.skups.append(nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2))  # 第3-第2上采样
        self.skups.append(DoubleConv(128 + 65 + 256, 128))  # 双卷积
    ...
    def forward(self, x):
        ...
        Dec_Br3_l_3TO2 = torch.cat([Dec_Br3_l3, Dec_Br1_l_4TransTO3, sc3], dim=1)  # [4,577,56,56]
        ...
        Dec_Br2_2TO1 = torch.cat([Dec_Br2_l2, Dec_Br3_3TransTO2, sc2], dim=1)  # [4,193,112,112]
        ...
        Dec_Br3_l2 = self.trans_conv[0](Dec_Br3_l2)
